...
```
```{r}
c2 = RdfLibBackend$new(identifier(id = "<http://openbiodiv.net/123>"))
nq = c2$nquad(subject = idshakespeare,    predicate = wrote,      object = idking_lear)
classics_rdflib <- rdf()
rdf_parse(nq, format = "nquads", classics_rdflib)
