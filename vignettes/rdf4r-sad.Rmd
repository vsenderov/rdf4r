...
[literal(text_value, xsd_type, lang)](#literals) constructor
...
What you get in terms of fields is:
...
sample_literal = list(
  ...
  lang = NULL,
  squote = "'John'^^xsd:string"
)

sample_literal2 = list(
  text_value = "That Seventies Show",
  xsd_type = NULL,
  lang = "en",
  squote = "'That Seventies Show'@en"
)

sample_literal3 = list(
  text_value = "That Seventies Show",
  xsd_type = NULL,
  lang = "en",
  squote = "'That Seventies Show'@en"
